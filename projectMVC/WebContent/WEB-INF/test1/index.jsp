...
<body>
  ...
  <div class="text-center">
		...
		<button  type="button" class="btn btn-primary" onclick="location.href='loginForm.do'">로그인</button>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
		<button  type="button" class="btn btn-primary" onclick="location.href='list.do'">테스트</button>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
	</div>
</body>
</html>